...
class BERTModel(BaseQAModel):
    """Wrapper mínimo para BERT QA usando Hugging Face pipeline."""
    def __init__(self, hf_name: str = "bert-large-uncased-whole-word-masking-finetuned-squad", device: str = "cpu") -> None:
        super().__init__(model_name="bert", device=device)
