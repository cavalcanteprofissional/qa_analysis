...
class RobertaModel(BaseQAModel):
    """Wrapper mínimo para RoBERTa QA usando Hugging Face pipeline."""
    def __init__(self, hf_name: str = "deepset/roberta-base-squad2", device: str = "cpu") -> None:
        super().__init__(model_name="roberta", device=device)
